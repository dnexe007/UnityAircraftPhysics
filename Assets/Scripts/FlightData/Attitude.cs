...
{
	public static Vector3 CalculateRightHorizontalVector(Transform transform)
	{
	...
	public static float CalculateRoll(Transform transform, Vector3 rightHorizontalVector)
	{
		return Vector3.SignedAngle(transform.right, rightHorizontalVector, transform.forward);
	}

	public static float CalculatePitch(Transform transform)
	{
